...
MARTOR_ALTERNATIVE_CSS_FILE = getattr(
    settings, "MARTOR_ALTERNATIVE_CSS_FILE", None
)
MARTOR_ALTERNATIVE_CSS_FILE_THEME = getattr(
    settings, "MARTOR_ALTERNATIVE_CSS_FILE_THEME", None
)
MARTOR_ADDITIONAL_CSS_FILE = getattr(
    settings, "MARTOR_ADDITIONAL_CSS_FILE", None
)
MARTOR_ALTERNATIVE_JQUERY_JS_FILE = getattr(
    settings, "MARTOR_ALTERNATIVE_JQUERY_JS_FILE", None
)
MARTOR_ALTERNATIVE_JQUERY_INIT_JS_FILE = getattr(
